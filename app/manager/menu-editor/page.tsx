    ...
    const toggleIngredient = (itemIdx: number, ingredientId: number) => {
        ...
        setItems((prev) => {
            ...
            if (currentIds.includes(ingredientId)) {
                newIngredientIds = currentIds.filter(
                    (id) => id !== ingredientId
                );
            } else {
            ...
            return prev.map((it, idx) =>
                idx === itemIdx
                    ? { ...it, ingredientIds: newIngredientIds }
                    : it
            );
        });
    };
                    ...
                    <div className="flex-1 overflow-y-auto border rounded-md p-4">
                        <div className="grid gap-4">
                            ...
                            {filteredItems.map((it, idx) => {
                                ...
                                const isEditingIngredients =
                                    editingIngredientsFor === it.id;
                                const ingredientCount =
                                    it.ingredientIds?.length || 0;
