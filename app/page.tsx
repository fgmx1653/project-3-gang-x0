            ...
            <div ref={contentRef} className="flex flex-col items-center gap-4">
                ...
                <div className="flex flex-row gap-4 flex-wrap justify-center">
                    ...
                    <Tooltip>
                        ...
                        <TooltipContent>
                            <p>
                                Real-time kitchen order tracking system for
                                managing pending and completed orders
                            </p>
                        </TooltipContent>
                    </Tooltip>
                    <Tooltip>
                        ...
                        <TooltipContent>
                            <p>
                                ...
                                appropriate user; yet to implement manager
                                dashboard and proper order submission
                            </p>
                        </TooltipContent>
                    </Tooltip>
                    <Link href="/locations">
